    ...
    return (
        <div className="zakaz-item">
            <div className="zakaz-item__header">
                <div className="zakaz-item__header-left">
                    <h3 className="zakaz-item__header-title">№{idzakaz}</h3>
                </div>
                <div className="zakaz-item__header-right">
                    <button className="btn btn__addZakaz"></button>
                    <button className="btn btn__deleteZakaz"></button>
                </div>
            </div>
            <div className="cart__item">
                ...
                <div className="cart__item-choice">
